...
urlpatterns = [
    ...
    path("api/student-inbox/", get_inbox_messages, name="student_inbox_api"),
    path("api/student-inbox/mark-read/", mark_inbox_message_read,
    ...
    path("api/cor-submissions/me/", get_my_cor_submissions, name="my_cor_submissions_api"),

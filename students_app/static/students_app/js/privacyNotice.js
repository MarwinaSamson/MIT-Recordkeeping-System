...
function renderProgress() {
  ...
  bar.innerHTML = STEPS.map((step, i) => {
    ...
    }"><div class="flex flex-col items-center"><div class="w-10 h-10 rounded-full flex items-center justify-center text-sm font-bold transition-all ${circleClass}">${
      checkmark
    }</div><span class="text-xs mt-2 text-center hidden sm:block max-w-[80px] ${labelClass}">${
      step.label

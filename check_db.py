...
cursor.execute("SELECT id, username, email, first_name, last_name FROM auth_user WHERE first_name LIKE '%Marwina%'")
...
for row in cursor.fetchall():
    print(f'App ID: {row[1]}, User ID: {row[2]}, Status: {row[3]}, Email: {row[4]}')
